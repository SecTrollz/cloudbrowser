...
echo ""
echo -e "  Profiles (HTTPS, self-signed cert — accept the browser warning):"
echo -e "    💼 Work      → ${BOLD}https://localhost:6901${RESET}"
echo -e "    🏠 Personal  → ${BOLD}https://localhost:6902${RESET}"
echo -e "    🔬 Research  → ${BOLD}https://localhost:6903${RESET}"
echo -e "    📱 Social    → ${BOLD}https://localhost:6904${RESET}"
echo -e "    🏦 Banking   → ${BOLD}https://localhost:6905${RESET}"
echo -e "    💻 Dev       → ${BOLD}https://localhost:6906${RESET}"
echo ""
echo -e "${YELLOW}  Login user: kasm_user — password is the *_VNC_PW value for that profile in .env${RESET}"
